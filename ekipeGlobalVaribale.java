package javaMethods;
import java.util.*;
public class ekipeGlobalVaribale {
    
    static int makeTeam1(int [] team1, int i)
    {
    ...
    public static void main(String[] args) {
        System.out.println("1  - Peter");    int p1=10;
        System.out.println("2  - Leon");     int p2=10;
        System.out.println("3  - Uroš");     int p3=9;
        System.out.println("4  - Beniman");  int p4=8;
        System.out.println("5  - Blaž");     int p5=6;
        System.out.println("6  - Adam");     int p6=7;
        System.out.println("7  - Nik");      int p7=6;
        System.out.println("8  - Živa");     int p8=5;
        System.out.println("9  - Lenart");   int p9=4;
        System.out.println("10 - Jure");    int p10=1;
        System.out.println("11 - Tomi");    int p11=3;
        System.out.println("12 - Ceki");    int p12=10;
